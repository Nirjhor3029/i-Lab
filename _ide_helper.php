 ...
 * Generated for Laravel 6.18.2 on 2021-01-07 11:38:13.
 *
...
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Idea[]|Idea create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Idea[]|Idea make($attributes = [])
    */
    class IdeaFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|IdeaFeedback[]|IdeaFeedback create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|IdeaFeedback[]|IdeaFeedback make($attributes = [])
    */
    class IdeaFeedbackFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Like[]|Like create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Like[]|Like make($attributes = [])
    */
    class LikeFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Permission[]|Permission create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Permission[]|Permission make($attributes = [])
    */
    class PermissionFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Role[]|Role create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Role[]|Role make($attributes = [])
    */
    class RoleFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|SendIdea[]|SendIdea create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|SendIdea[]|SendIdea make($attributes = [])
    */
    class SendIdeaFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|ShortListedIdea[]|ShortListedIdea create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|ShortListedIdea[]|ShortListedIdea make($attributes = [])
    */
    class ShortListedIdeaFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Upload[]|Upload create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Upload[]|Upload make($attributes = [])
    */
    class UploadFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
