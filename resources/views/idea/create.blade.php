        ...
        <div class="col-12 col-sm-10 col-md-9 offset-md-1 col lg-9 offset-lg-1">
            ...
            <div class="row">
                <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                    ...
                    {!! Form::text('title', null, ['class' => 'form-control custom-form-control', 'required', 'id'=>'title', 'maxlength' => '120']) !!}
            ...
            <div class="row">
                <div class="form-group col-12">
                    ...
                    {!! Form::textarea('elevator_pitch', null, ['class' => 'form-control custom-form-control custom-form-control-text-area', 'rows' => '3', 'required','id'=>'elevator_pitch', 'maxword' => '300']) !!}
            ...
            <div class="row" style="display: none" >
				<div style="margin-left:15px">Upload (Document/ Video) Limit left: <span style="color: purple;font-weight:bold" id="uploadLimit"></span></div><br>
                    ...
                    <div>
                        <div class="row" style="display: flex; align-items: center;">
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <input type="file" id="upload_form" class="form-control-file custom-form-control" name="image[]" value="" disabled/>
