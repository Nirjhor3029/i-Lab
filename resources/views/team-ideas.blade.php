...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-7 offset-md-1 col-lg-7 offset-lg-1" style="display:none" :style="loading == true ? 'display:none' : 'display:block'">
        ...
        {{-- <div class="filter" style="display:none" :style="loading == true? 'display:none' : 'display:block'">
            <div class="filter__tabs row">
                <div id="tab" class="row" style="visibility:visible">
                    <div>
                        <input type="text" autocomplete="off" name="date" id="demo-1" v-model="dateField" @focus="CallDatePicker()" class="form-control custom-form-control filter__date" placeholder="Date">
                    </div>
                    <div>
                        <select class="custom-form-control filter__select" id="topicId" v-model="topicField" @change="filterAllIdea(dateField)" title="Topic"> 
                    ...
                    <div>
                        <select name="uname" class="custom-form-control filter__name" id="nameId" v-model="nameField" @change="filterAllIdea(dateField)" title="Name">
...
@section('customJS')
    ...
    <script>
			...
			const app = new Vue({
				...
				methods: {
					getIdea() {
						axios.get('/secure/dashboard/team-ideas-published').then((response) => {
